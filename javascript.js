Shery.imageEffect(".back", {style: 5 , config:
    ...
    "aspect":{"value":2.1896272285251217},
    ...
    "growSize":{"value":1.21,"range":[1,15]},"durationOut":{"value":1.1,"range":[0.1,5]},
    "durationIn":{"value":1.1,"range":[0.1,5]},"displaceAmount":{"value":0.5},"masker":{"value":false},
    "maskVal":{"value":1,"range":[1,5]},"scrollType":{"value":0},"geoVertex":{"range":[1,64],"value":1},
    "noEffectGooey":{"value":false},"onMouse":{"value":1},"noise_speed":{"value":0.92,"range":[0,10]},
...
document.querySelector('.main').addEventListener('click',function(){
    ...
    if(!animating){
        ...
        gsap.to(h1s[index],{
            ...
            onComplete: function(){
                gsap.set(this._targets[0], {top: '105%'});
                animating = false;
            },
        })
